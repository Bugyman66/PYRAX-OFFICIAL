...
export default function Footer() {
  ...
  const footerLinks = {
    technology: [
      { name: navT('tristream'), href: `/${locale}/technology` },
      { name: navT('evmSidechain'), href: `/${locale}/technology#evm` },
      { name: navT('zkRollups'), href: `/${locale}/technology#zkrollups` },
      { name: navT('wasmContracts'), href: `/${locale}/technology#wasm` },
    ],
    resources: [
  ...
  return (
    <footer className="relative bg-stone-950 border-t border-stone-800">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href={`/${locale}`} className="flex items-center gap-3 mb-4">
              <Image
                src="/pyrax-brand/pyrax-coin.svg"
                alt="PYRAX"
                width={40}
                height={40}
          ...
          {/* Technology */}
          <div>
            <h3 className="text-sm font-semibold text-white mb-4">{t('technology')}</h3>
          ...
          {/* Resources */}
          <div>
            <h3 className="text-sm font-semibold text-white mb-4">{t('resources')}</h3>
            <ul className="space-y-3">
          ...
          {/* Community */}
          <div>
            <h3 className="text-sm font-semibold text-white mb-4">{t('community')}</h3>
            <ul className="space-y-3">
