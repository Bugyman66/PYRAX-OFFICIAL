...
export default function MediaReleasesPage() {
    ...
    <main className="min-h-screen bg-stone-950">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 mb-6">
              ...
              <span className="text-blue-400 font-medium">{t('media.badge')}</span>
            </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <FilmIcon className="w-16 h-16 text-stone-600 mx-auto mb-6" />
            <h2 className="text-2xl font-bold text-white mb-4">{t('comingSoon')}</h2>
            <p className="text-stone-400 max-w-md mx-auto">
              {t('media.comingSoonDesc')}
            </p>
          </motion.div>
        </div>
      </section>
