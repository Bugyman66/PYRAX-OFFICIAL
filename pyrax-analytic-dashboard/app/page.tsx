        ...
        return (
            <div className="min-h-screen flex items-center justify-center p-4">
                <div className="text-center space-y-4">
                    ...
                    <h1 className="text-xl font-bold text-danger">Connection Failed</h1>
                    <p className="text-muted-foreground">Could not connect to PYRAX Metrics API.</p>
                </div>
            </div>
        );
    }
                    ...
                    <div className="flex items-center gap-3 mt-1">
                        <p className="text-muted-foreground text-sm flex items-center gap-2">
                            <span className="relative flex h-2 w-2">
                                <span className={`animate-ping absolute inline-flex h-full w-full rounded-full opacity-75 ${alerts.stalled ? "bg-danger" : "bg-success"}`}></span>
                                <span className={`relative inline-flex rounded-full h-2 w-2 ${alerts.stalled ? "bg-danger" : "bg-success"}`}></span>
                            </span>
                            {alerts.stalled ? "Network Stalled" : "Operational"}
                        </p>
                    </div>
                </div>

                <div className="flex gap-2 text-xs font-mono text-muted-foreground bg-secondary/50 px-3 py-1.5 rounded-lg border border-border">
                    <span>Client v0.1.0</span>
                    <span>•</span>
                    <span>Target: {nodes.length} nodes</span>
                </div>
            </div>
